...
const { AstracoreLib } = require('crypto-wallet-core');
...
describe('Chain BTC', function () {
  describe('#getAstracoreTx', function () {
    it('should create a valid astracore TX', function () {
      var txp = TxProposal.fromObj(aTXP());
      var t = ChainService.getAstracoreTx(txp);
      should.exist(t);
    });
    it('should order outputs as specified by outputOrder', function () {
      ...
      var t2 = ChainService.getAstracoreTx(txp);
      t2.getChangeOutput().should.deep.equal(t2.outputs[0]);
    });

    it('should create a valid signed astracore TX', function () {
    ...
    it('should create a valid unsigned astracore TX', function () {
      var txp = TxProposal.fromObj(signedTxp);
      var t = ChainService.getAstracoreTx(txp, { signed: false });
      should.exist(t);
  ...
  describe('#getEstimatedSize', function () {
    ...
    before(function () {
      ...
      simpleUtxoWith1BTC = {
        ...
        outputIndex: 0,
        script: AstracoreLib.Script.buildPublicKeyHashOut(fromAddress).toString(),
        satoshis: 1e8,
      };
      ...
      simpleWitnessUtxoWith1BTC = {
        ...
        outputIndex: 0,
        script: AstracoreLib.Script.fromAddress(witnessFromAddress).toString(),
        satoshis: 1e8,
      };
      const privKey = new AstracoreLib.PrivateKey();
    });
    it('1  input p2pkh,1 output p2pkh  ', function () {
      ...
      // Create a similar TX.
      let tx = new AstracoreLib.Transaction();
    ...
    const p2shPrivateKey1 = AstracoreLib.PrivateKey.fromWIF('cNuW8LX2oeQXfKKCGxajGvqwhCgBtacwTQqiCGHzzKfmpHGY4TE9');
    const p2shPublicKey1 = p2shPrivateKey1.toPublicKey();
    const p2shPrivateKey2 = AstracoreLib.PrivateKey.fromWIF('cTtLHt4mv6zuJytSnM7Vd6NLxyNauYLMxD818sBC8PJ1UPiVTRSs');
    const p2shPublicKey2 = p2shPrivateKey2.toPublicKey();
    const p2shPrivateKey3 = AstracoreLib.PrivateKey.fromWIF('cQFMZ5gP9CJtUZPc9X3yFae89qaiQLspnftyxxLGvVNvM6tS6mYY');
    const p2shPublicKey3 = p2shPrivateKey3.toPublicKey();

    const p2shAddress = AstracoreLib.Address.createMultisig(
      [
        p2shPublicKey1,
        p2shPublicKey2,
        //      p2shPublicKey3
    ...
    const p2shUtxoWith1BTC = {
      ...
      txId: 'a477af6b2667c29670467e4e0728b685ee07b240235771862318e29ddbe58458',
      outputIndex: 0,
      script: AstracoreLib.Script(p2shAddress).toString(),
      satoshis: 1e8,
    };

    const p2wshAddress = AstracoreLib.Address.createMultisig(
      [
        p2shPublicKey1,
        p2shPublicKey2,
        //      p2shPublicKey3
      ...
      'testnet',
      null,
      AstracoreLib.Address.PayToWitnessScriptHash
    );
    const p2wshUtxoWith1BTC = {
      address: p2wshAddress.toString(),
      txId: 'a477af6b2667c29670467e4e0728b685ee07b240235771862318e29ddbe58458',
      outputIndex: 0,
      script: AstracoreLib.Script(p2wshAddress).toString(),
      satoshis: 1e8,
    };
