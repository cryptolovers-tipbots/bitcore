...
var Input = astracore.Transaction.Input;
var Output = astracore.Transaction.Output;
var PrivateKey = astracore.PrivateKey;
var Script = astracore.Script;
var Interpreter = astracore.Script.Interpreter;
var Address = astracore.Address;
var Networks = astracore.Networks;
var Opcode = astracore.Opcode;
var errors = astracore.errors;
...
describe('Transaction', function () {
  ...
  it('fromObject with pay-to-public-key previous outputs', function () {
    ...
    tx.inputs[0].should.be.instanceof(astracore.Transaction.Input.PublicKey);
  ...
  var p2wshAddress = Address.createMultisig(
    ...
    'testnet',
    null,
    Address.PayToWitnessScriptHash
  );
  ...
  describe('serialization of inputs', function () {
    ...
    it('can serialize and deserialize a P2PWKH input', function () {
      var transaction = new Transaction().from(simpleWitnessUtxoWith1BTC);
      var deserialized = new Transaction(transaction.toObject());
      expect(deserialized.inputs[0] instanceof Transaction.Input.PublicKeyHash).to.equal(true);
    });
    it('can serialize and deserialize a wrapped P2PWKH input', function () {
      var transaction = new Transaction().from(simpleWrappedWitnessUtxoWith1BTC);
      var deserialized = new Transaction(transaction.toObject());
      expect(deserialized.inputs[0] instanceof Transaction.Input.PublicKeyHash).to.equal(true);
    });
  ...
  describe('checks on adding inputs', function () {
    ...
    it('will add an empty script if not supplied', function () {
      ...
      transaction.inputs[0].output.script.should.be.instanceof(astracore.Script);
  ...
  describe('Segregated Witness', function () {
    ...
    describe('verifying', function () {
      it('will verify these signatures', function () {
        var signedTxBuffer = Buffer.from(
        ...
        var unsignedBuffer = Buffer.from(
        ...
        var signedTx = astracore.Transaction().fromBuffer(signedTxBuffer);
        ...
        var signatures = [
          {
            ...
            sigtype: astracore.crypto.Signature.SIGHASH_ALL,
          },
          {
        ...
        var pubkey1 = astracore.PublicKey('0236c8204d62fd70e7ca206a36d39f9674fa832964d787c60d44250624242bada4');
        var pubkey3 = astracore.PublicKey('0266cd5a3507d6df5346aa42bd23d4c44c079aef0d7a59534758a0dabb82345c20');
        var expectedDestScript = astracore.Script('a914382ead50307554bcdda12e1238368e9f0e10b11787');
        var expectedMultiSigString =
        ...
        var expectedMultiSig = astracore.Script(expectedMultiSigString);
        var multiSig = astracore.Script.buildMultisigOut([pubkey1, pubkey3], 2, {
          noSorting: true,
        });
        multiSig.toBuffer().toString('hex').should.equal(expectedMultiSigString);
        var wits = astracore.Script.buildWitnessMultisigOutFromScript(multiSig);

        var expectedWits = astracore.Script('0020fde78ea47ae10cc93c6a850d8a86d8575ddacff38ee9b0bc6535dc016a197068');
        wits
          .toBuffer()
          .toString('hex')
          .should.equal('0020fde78ea47ae10cc93c6a850d8a86d8575ddacff38ee9b0bc6535dc016a197068');
      ...
      describe('Bitcoin Core tests', function () {
        ...
        it('will verify pay-to-compressed publickey (v0) part 1', function () {
          ...
          var flags;
          var interpreter;
          var output1 = astracore.Transaction(
          ...
          var input1 = astracore.Transaction(
        ...
        it('will verify pay-to-compressed publickey (v0) part 2', function () {
          ...
          var input2 = astracore.Transaction(
        ...
        it('will verify witness 2-of-2 multisig (part 2)', function () {
          ...
          var check;
          var interpreter;
          var output2 = astracore.Transaction(
    ...
    describe('signing', function () {
      ...
      var address = Address.createMultisig([publicKey1], 1, 'testnet');
      var utxo = {
      ...
      var nestedAddress = Address.createMultisig([publicKey1], 1, 'testnet', true);
      var nestedUtxo = {
      ...
      var witnessAddress = Address.createMultisig([publicKey1], 1, 'testnet', false, Address.PayToWitnessScriptHash);
      var witnessUtxo = {
      ...
      it('will sign with nested p2sh witness program', function () {
        var tx = new Transaction()
          ...
          .sign(privateKey1);
        var sighash = tx.inputs[0].getSighash(tx, privateKey1, 0, astracore.crypto.Signature.SIGHASH_ALL);
      ...
      it('will sign with p2wpkh witness program', function () {
        ...
        tx.toBuffer()
          .toString('hex')
          .should.equal(
            ''
          );
      });
      it('will sign with p2sh-wrapped-p2wpkh witness program', function () {
        ...
        tx.toBuffer()
          .toString('hex')
          .should.equal(
            ''
          );
      });
      it('will sign with p2wsh witness program', function () {
        ...
        tx.toBuffer()
          .toString('hex')
          .should.equal(
            ''
          );
      });
      it('will sign with p2wsh, p2sh, and nested p2sh', function () {
        ...
        tx.toBuffer()
          .toString('hex')
          .should.equal(
            ''
          );
      });
      it('will sign with p2pkh, p2wpkh, and wrapped p2wpkh', function () {
        ...
        tx.toBuffer()
          .toString('hex')
          .should.equal(
            ''
          );
      });
    });
  });
