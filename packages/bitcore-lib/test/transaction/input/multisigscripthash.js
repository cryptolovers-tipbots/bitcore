...
var MultiSigScriptHashInput = astracore.Transaction.Input.MultiSigScriptHash;
...
describe('MultiSigScriptHashInput', function () {
  ...
  it('will get the scriptCode for nested witness', function () {
    ...
    var transaction = new Transaction().from(utxo, [public1, public2, public3], 2, true).to(address, 1000000);
    var input = transaction.inputs[0];
  ...
  describe('P2WSH', function () {
    it('can count missing signatures', function () {
      var transaction = new Transaction().from(witnessOutput, [public1, public2, public3], 2).to(address, 1000000);
      var input = transaction.inputs[0];
