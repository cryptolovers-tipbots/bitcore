...
describe('Script', function () {
  ...
  describe('#isPublicKeyIn', function () {
    it('correctly identify scriptSig as a public key in', function () {
      ...
      var script = astracore.Script.fromBuffer(scriptBuffer);
  ...
  describe('#isWitnessScriptHashOut', function () {
    ...
    it('should NOT identify as p2wsh', function () {
      Script('OP_0 20 0x799d283e7f92af1dd242bf4eea513c6efd117de2').isWitnessScriptHashOut().should.equal(false);
    });
  });

  describe('#isWitnessPublicKeyHashOut', function () {
    it('should identify as p2wpkh', function () {
      Script('OP_0 20 0x799d283e7f92af1dd242bf4eea513c6efd117de2').isWitnessPublicKeyHashOut().should.equal(true);
  ...
  describe('#isWitnessProgram', function () {
    it('will default values to empty object', function () {
      Script('OP_0 20 0x799d283e7f92af1dd242bf4eea513c6efd117de2').isWitnessProgram().should.equal(true);
    });
    ...
    it('will return false if first byte op_code is greater than OP_16', function () {
      Script('OP_NOP 20 0x799d283e7f92af1dd242bf4eea513c6efd117de2').isWitnessProgram().should.equal(false);
    });
    it('will return true with datapush of 20', function () {
      var values = {};
      Script('OP_0 20 0x799d283e7f92af1dd242bf4eea513c6efd117de2').isWitnessProgram(values).should.equal(true);
  ...
  describe('#buildWitnessMultisigOutFromScript', function () {
    it('it will build nested witness scriptSig', function () {
      var redeemScript = astracore.Script();
      var redeemHash = astracore.crypto.Hash.sha256(redeemScript.toBuffer());
  ...
  describe('#getSignatureOperationsCount', function () {
    ...
    it('should handle P2SH-multisig-in scripts from utility', function () {
      ...
      var signature = astracore.crypto.Signature.fromString('30060201FF0201FF');
