...
describe('URI', function () {
  ...
  it('parses uri strings correctly (test vector)', function () {
    ...
    uri = URI.parse(
      'litecoin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?amount=123.22' + '&other-param=something&req-extra=param'
    );
    uri.address.should.equal('LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3');
    uri.amount.should.equal('123.22');
  ...
  it('URIs can be validated statically (test vector)', function () {
    ...
    URI.isValid('litecoin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?amount=1.2').should.equal(true);
    URI.isValid('litecoin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?amount=1.2&other=param').should.equal(true);
    URI.isValid('litecoin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?amount=1.2&req-other=param', ['req-other']).should.equal(
      true
    );
    URI.isValid(
      'litecoin:mmrqEBJxUCf42vdb3oozZtyz5mKr3Vb2Em?amount=0.1&' +
    ...
    URI.isValid('litecoin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?amount=1.2&req-other=param').should.equal(false);
    URI.isValid('litecoin:?r=https%3A%2F%2Ftest.bitpay.com%2Fi%2F6DKgf8cnJC388irbXk5hHu').should.equal(false);
  });
  ...
  describe('instantiation from litecoin uri', function () {
    ...
    it('parses address', function () {
      ...
      uri.address.should.be.instanceof(astracore.Address);
    ...
    it('has no false negative when checking supported features', function () {
      uri = new URI('litecoin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?amount=1.2&other=param&' + 'req-required=param', [
        'req-required',
      ]);
      uri.address.should.be.instanceof(astracore.Address);
  ...
  it('should input/output String', function () {
    var str =
      'litecoin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?' + 'message=Donation%20for%20project%20xyz&label=myLabel&other=xD';
  ...
  it('should generate a valid URI', function () {
    new URI({
      ...
      .toString()
      .should.equal('litecoin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3');
    ...
    new URI({
      ...
      .toString()
      .should.equal('litecoin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?amount=1.10001&message=Hello%20World&something=else');
  });
