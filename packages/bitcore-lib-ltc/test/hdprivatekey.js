...
describe('HDPrivate key interface', function () {
  ...
  describe('public key', function () {
    var testnetKey = new HDPrivateKey(
      'ttpv96BtqegdxXcePuExhVwms6Q9nPtEbFKC2txyjpTpycy6dSt7AuAfK3EHTSsf3qKgkD2kGfmRbMXvM8tkcV4i4GF3uU6fewDoAnXdzMVL99i'
    );
    var livenetKey = new HDPrivateKey(
      'Ltpv71G8qDifUiNetcgj3gpe5PerjX2sK9yVfFFMbmxsBXGGyUwdKsJConpcJhEPH5x9E4HH5EA8U8hSTkSVnYvUpW7fWhfun8d7LwSSSt6Tecx'
    );
  ...
  describe('conversion to plain object/json', function () {
    var plainObject = {
      ...
      checksum: -1489917903,
      xprivkey:
        'Ltpv71G8qDifUiNetP6nmxPA5STrUVmv2J9YSmXajv8VsYBUyuPhvN9xCaQrfX2wo5' +
