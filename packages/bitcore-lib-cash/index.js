...
astracore.versionGuard = function (version) {
  if (version !== undefined) {
    var message =
      'More than one instance of astracore-lib-cash found. ' +
...
astracore.versionGuard(global._astracoreCash);
global._astracoreCash = astracore.version;

// crypto
astracore.crypto = {};
astracore.crypto.BN = require('./lib/crypto/bn');
astracore.crypto.ECDSA = require('./lib/crypto/ecdsa');
astracore.crypto.Schnorr = require('./lib/crypto/schnorr');
...
astracore.util.base32 = require('./lib/util/base32');
astracore.util.convertBits = require('./lib/util/convertBits');
