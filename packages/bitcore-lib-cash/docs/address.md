...
The errors are listed in the generated file in the [errors folder](https://github.com/bitpay/astracore/tree/master/packages/astracore-lib-cash/lib/errors). There's a structure to errors defined in the [spec.js file](https://github.com/bitpay/astracore/blob/master/packages/astracore-lib-cash/lib/errors/spec.js).
