...
var Astracore = require('crypto-wallet-core').AstracoreLib;
...
describe('Utils', () => {
  ...
  describe('#verifyRequestPubKey', () => {
    it('should generate and check request pub key', () => {
      var reqPubKey = new Astracore.PrivateKey().toPublicKey();
      var xPrivKey = new Astracore.HDPrivateKey();
      var xPubKey = new Astracore.HDPublicKey(xPrivKey);
    ...
    it('should fail to check a request pub key with wrong key', () => {
      ...
      var xPrivKey2 = new Astracore.HDPrivateKey();
      var xPubKey2 = new Astracore.HDPublicKey(xPrivKey2);
