...
export class Key {
  ...
  static fromExtendedPrivateKey = function (xPriv, opts) {
    ...
    let xpriv;
    try {
      xpriv = new Astracore.HDPrivateKey(xPriv);
    } catch (e) {
  ...
  get = function (password) {
    ...
    if (this.isPrivKeyEncrypted()) {
      ...
      try {
        ...
        if (!this.fingerPrint) {
          let xpriv = new Astracore.HDPrivateKey(keys.xPrivKey);
  ...
  derive = function (password, path) {
    ...
    var xPrivKey = new Astracore.HDPrivateKey(this.get(password).xPrivKey, NETWORK);
  ...
  createCredentials = function (password, opts) {
    ...
    if (opts.network == 'testnet') {
      ...
      xPrivKey = new Astracore.HDPrivateKey(x);
    }
  ...
  createAccess = function (password, opts) {
    ...
    var requestPrivKey = new Astracore.PrivateKey(opts.requestPrivKey || null);
  ...
  sign = function (rootPath, txp, password, cb) {
    ...
    var xpriv = new Astracore.HDPrivateKey(derived);
